...
class BackStackFragmentB : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = if (view != null) view else inflater.inflate(R.layout.fragment_back_stack_b, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonStartNext.setOnClickListener {
            addFragment(BackStackFragmentC())
        }
    }
    ...
    companion object {
        val TAG = BackStackFragmentB.javaClass.name
    }
}
