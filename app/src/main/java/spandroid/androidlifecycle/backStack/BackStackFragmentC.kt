...
class BackStackFragmentC : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = if (view != null) view else inflater.inflate(R.layout.fragment_back_stack_c, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonStartNext.setOnClickListener {
            addFragment(BackStackFragmentD())
        }
    }
    ...
    companion object {
        val TAG = BackStackFragmentC.javaClass.name
    }
}
