...
class BackStackFragmentD : BaseFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = if (view != null) view else inflater.inflate(R.layout.fragment_back_stack_d, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonStartNext.setOnClickListener {
            addFragment(BackStackFragmentA())
        }
    }
    ...
    companion object {
        val TAG = BackStackFragmentD.javaClass.name
    }
}
